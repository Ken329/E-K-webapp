...
export default function Plus(props) {
    ...
    return (
        ...
        <div class="bg-blue-100 shadow-inner rounded-md p-4 my-5 mx-2 flex items-center justify-center cursor-pointer md:mx-0">
            {
                !click
                    ...
                    : <>
                        <form onSubmit={onsubmit} class="flex w-full">
                            <input
                                type="textarea"
                                class="block w-4/5 p-4 mt-3 text-gray-800 italic border border-gray-300 rounded-lg bg-gray-50 text-sm outline-none mr-2 md:text-md w-full focus:border-gray-400"
                                onChange={event => setValue(event.target.value)}
                                required
                            />
                            <div class="ml-3 mt-3 flex justify-center md:justify-end">
